...
import com.example.clientnewsvk.data.model.ContainerProfileInfoDto
...
interface ApiService {
    ...
    @GET("$NAME_OF_GET_PROFILE_INFO?")
    suspend fun getProfileInfo(
        @Query("v") version: String = API_VERSION,
    ): ContainerProfileInfoDto
    ...
    companion object {
        ...
        private const val NAME_OF_GET_PROFILE_INFO = "account.getProfileInfo"
